...
{name:"Pepper Pop",value:3,duration:5,keywords:["Food","Drink"],text:"+1 ATK"},
{name:"Rock Candy",value:3,duration:5,keywords:["Food"],text:"+1 DEF"},
{name:"Herbal Tea",value:4,duration:1,keywords:["Food","Drink"],text:"Remove all status"},
{name:"Green Tea",value:2,duration:1,keywords:["Food","Drink"],text:"Remove Drowsy"},
{name:"Ginger Root",value:2,duration:1,keywords:["Food"],text:"Remove Nauseous"},
{name:"Breath Mint",value:2,duration:1,keywords:["Food"],text:"Remove Toasty"},
{name:"Cinnamon Drop",value:2,duration:1,keywords:["Food"],text:"Remove Chilly"},
{name:"Lemon Drop",value:2,duration:1,keywords:["Food"],text:"Remove Crackly"},
{name:"Mint Gum",value:3,duration:5,keywords:["Food"],text:"Immune to Toasty"},
{name:"Cinnamon Gum",value:3,duration:5,keywords:["Food"],text:"Immune to Chilly"},
{name:"Fruity Gum",value:3,duration:5,keywords:["Food"],text:"Immune to Crackly"}
];
export const EQUIPMENT=[{name:"Baseball Bat",value:3,durability:5,type:"Weapon",keywords:["Object"],text:"Plus 1 for any basic attack made"},{name:"Running Shoes",value:3,durability:5,type:"Gadget",keywords:["Object","Clothing"],text:"You may move first in an encounter"},{name:"Yo-yo",value:3,durability:5,type:"Weapon",keywords:["Object","Toy"],text:"Your basic attacks may hit one adjacent enemy"},{name:"Ball Cap",value:3,durability:5,type:"Armor",keywords:["Object","Clothing"],text:"Minus 1 damage when defending"},{name:"Leather Jacket",value:8,durability:10,type:"Armor",keywords:["Object","Clothing"],text:"Minus 1 damage when defending"},{name:"Firecracker",value:5,durability:1,type:"Gadget",keywords:["Object","Toy"],text:"All enemies take 1 damage, 2 if Flammable"},{name:"Megaphone",value:5,durability:8,type:"Gadget",keywords:["Object"],text:"When defending, roll 2D6. If enemy action matches that roll, it fails."},{name:"Parka",value:4,durability:5,type:"Armor",keywords:["Clothing"],text:"+1 DEF, +2 against Cold enemies; immune to Chilly"},{name:"Rubber Boots",value:4,durability:5,type:"Armor",keywords:["Clothing"],text:"+1 DEF, +2 against Charged enemies; immune to Crackly"}];
